package com.example.demobai5.Utils;

import com.example.demobai5.service.CustomUserDetailService;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain (HttpSecurity http) throws Exception{
        return http.csrf().disable()
                .authorizeHttpRequests(auth -> auth.requestMatchers("/css/**", "/js/**", "/", "/register","/error")
                        .permitAll().requestMatchers("/books/edit", "/book/delete").authenticated().requestMatchers("/books", "/books/add")
